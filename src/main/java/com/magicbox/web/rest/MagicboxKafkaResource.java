...
@RestController
@RequestMapping("/api/magicbox-kafka")
public class MagicboxKafkaResource {
    private final Logger log = LoggerFactory.getLogger(MagicboxKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MagicboxKafkaResource(KafkaProperties kafkaProperties) {
